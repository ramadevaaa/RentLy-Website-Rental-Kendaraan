            ...
            <div class="form-content">
                <form action="{{ route('admin.kendaraan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" class="form-control @error('kategori') is-invalid @enderror" required>
                                ...
                                <option value="pickup" {{ old('kategori')=='pickup'?'selected':'' }}>Pickup</option>
                                <option value="van" {{ old('kategori')=='van'?'selected':'' }}>Van</option>
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Tahun *</label>
                            <input type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror" value="{{ old('tahun', date('Y')) }}" min="1900" max="{{ date('Y')+1 }}" required>
                            @error('tahun')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="form-group">
                            <label>Warna *</label>
                            <input type="text" name="warna" class="form-control @error('warna') is-invalid @enderror" value="{{ old('warna') }}" required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="harga_per_hari" class="form-control @error('harga_per_hari') is-invalid @enderror" value="{{ old('harga_per_hari') }}" min="0" required>
